			...
			<view class="content_3">
				...
				<view class="content_3_2">
					<view class="content_3_2_1" @click="goMyTeam">
						<image class="content_3_2_1_1" src="../../static/wodetd.webp"
							style="width:45rpx;height: 47rpx;" />
						<view class="content_3_2_1_2">我的团队</view>
					</view>
					<view class="content_3_2_1" @click="goVerified">
						<image class="content_3_2_1_1" src="../../static/shimrz.webp"
							style="width:40rpx;height: 47rpx;" />
						<view class="content_3_2_1_2">实名认证</view>
					</view>
					<view class="content_3_2_1" @click="goPromote">
						<image class="content_3_2_1_1" src="../../static/haibao.webp"
							style="width:41rpx;height: 50rpx;" />
						<view class="content_3_2_1_2">推广海报</view>
					</view>
					<view class="content_3_2_1" @click="goPointsMall">
						<image class="content_3_2_1_1" src="../../static/jfsc.webp"
							style="width:48rpx;height: 39rpx;" />
						<view class="content_3_2_1_2">积分商城</view>
					</view>
					<view class="content_3_2_1" @click="goFeedback">
						<image class="content_3_2_1_1" src="../../static/yijfk.webp"
							style="width:51rpx;height: 46rpx;" />
						<view class="content_3_2_1_2">问题反馈</view>
					</view>
					<view class="content_3_2_1" @click="goSetting">
						<image class="content_3_2_1_1" src="../../static/shezhi.webp"
			...
			memberIndex() {
				memberIndex().then(res => {
					...
					res.data.num.forEach((item, index) => {
						if (item.status != 1 && index == 0) this.num.push(0)
						else this.num.push(item.num)
						if (item.status != 2 && index == 1) this.num.push(0)
						else this.num.push(item.num)
						if (item.status != 3 && index == 2) this.num.push(0)
						else this.num.push(item.num)
						if (item.status != 4 && index == 3) this.num.push(0)
						else this.num.push(item.num)
						this.count += item.num
					});
				})
